...
struct Frame {
    ...
    int32_t x_offset = 0;
    int32_t y_offset = 0;
    int32_t delay = 0; // in milliseconds
    int8_t disposal = 0;
    int8_t blending = 0;
};
...
public:
    ...
    Frame& current_frame();
    int32_t frame_count() { return m_frame_count; }
    int32_t play_count() { return m_play_count; }
private:
    std::ifstream m_filestream;
    Frame m_current_frame;
    int32_t m_frame_count = 0;
    int32_t m_play_count = 0;
};
